...
import numpy as np
import pandas as pd
from src.constants import INTERVAL_KEY, CAGR_KEY, MAX_DRAWDOWN_KEY, SHARPE_KEY
import matplotlib.pyplot as plt
from method.Method import Method
from data_analysis.financials import Financials
from library.kpi import CAGR, Sharpe, MaxDrawDown
...
class PortfolioRebalance(Method):
    ...
    def backtest(self, prices, ref_prices, params):
        ...
        print("CAGR - Portfolio: {}".format(cagr[CAGR_KEY]["mon_ret"]))
        print("Sharpe - Portfolio: {}".format(sharpe[SHARPE_KEY]["mon_ret"]))
        print("MAX-Drawdown - Portfolio: {}".format(max_dd[MAX_DRAWDOWN_KEY]["mon_ret"]))
        print("CAGR - Ref: {}".format(cagr_ref[CAGR_KEY]["^DJI"]))
        print("Sharpe - Ref: {}".format(sharpe_ref[SHARPE_KEY]["^DJI"]))
        print("MAX-Drawdown - Ref: {}".format(max_dd_ref[MAX_DRAWDOWN_KEY]["^DJI"]))
